	...
	for(var i=0;i<sels.length;i++){
		if (ts_check(sels[i],ts_selectclass))
		{
			...
			for(var j=0;j<sels[i].getElementsByTagName('option').length;j++)
			{
				...
				var newico = sels[i].getElementsByTagName('option')[j].getAttribute('data-img');
				...
				if(newico){
					...
					newimg.setAttribute('src', "images/"+newico);
					newimg.setAttribute('class', "option_ico");
				...
				newa.setAttribute('class', "option_a");
